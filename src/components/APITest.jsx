...
// Note: This code is a React component that uses hooks to manage state and handle file uploads.
// It does not include any external libraries or frameworks, making it a pure JSX/JS solution.